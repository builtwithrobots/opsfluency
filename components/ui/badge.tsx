...
const colors = {
  ...
  // OpsFluency signal palette — colors defined in globals.css (--color-signal-*)
  'signal-live':    'bg-(--color-signal-live)/15    text-(--color-signal-live)    group-data-hover:bg-(--color-signal-live)/25',
  'signal-ok':      'bg-(--color-signal-ok)/15      text-(--color-signal-ok)      group-data-hover:bg-(--color-signal-ok)/25',
  'signal-warn':    'bg-(--color-signal-warn)/15    text-(--color-signal-warn)    group-data-hover:bg-(--color-signal-warn)/25',
  'signal-urgent':  'bg-(--color-signal-urgent)/15  text-(--color-signal-urgent)  group-data-hover:bg-(--color-signal-urgent)/25',
  'signal-info':    'bg-(--color-signal-info)/15    text-(--color-signal-info)    group-data-hover:bg-(--color-signal-info)/25',
  'signal-neutral': 'bg-(--color-signal-neutral)/15 text-(--color-signal-neutral) group-data-hover:bg-(--color-signal-neutral)/25',
  'signal-hub':     'bg-(--color-signal-hub)/15     text-(--color-signal-hub)     group-data-hover:bg-(--color-signal-hub)/25',
