...
export function Legend({
  ...
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        'text-base/6 font-semibold text-dc-text data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Label({ className, ...props }: { className?: string } & Omit<Headless.LabelProps, 'as' | 'className'>) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        'text-base/6 text-dc-text select-none data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      {...props}
      className={clsx(className, 'text-base/6 text-dc-text-2 data-disabled:opacity-50 sm:text-sm/6')}
    />
  )
}
